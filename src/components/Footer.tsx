  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="min-w-0 lg:col-span-5 space-y-4 md:space-y-6">
            ...
            <Link href="/" className="flex items-center gap-3">
              <div className="relative w-12 h-12 transition-transform hover:scale-105">
                <Image
                  ...
                  alt=""
                  fill
                  className="object-contain scale-[1.2] mix-blend-screen"
                />
              </div>
              <div>
        ...
        <div className="grid min-w-0 grid-cols-2 gap-6 lg:contents">

          {/* Middle Column: Resource links */}
          <div className="min-w-0 lg:col-span-3 space-y-4">
            <h2 className="text-xs font-bold tracking-widest text-[#f5f1ea] uppercase">
              LIÊN HỆ & TÀI LIỆU
            </h2>
            <ul className="space-y-3 text-xs font-sans">
              <li>
                <Link href="/#process" className="hover:text-white transition-colors duration-200 block">
                  Hồ sơ năng lực
                </Link>
              </li>
            </ul>
          ...
          <div className="min-w-0 lg:col-span-4 space-y-4">
            ...
            <ul className="space-y-3.5 text-xs font-light leading-relaxed">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <a href="https://www.tiktok.com/@nou.design?is_from_webapp=1&sender_device=pc" target="_blank" rel="noreferrer" className="min-w-0 break-words hover:text-white transition-colors duration-200">
      ...
      {/* Underbar footer row */}
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-10 md:mt-16 pt-6 md:pt-8 border-t border-neutral-900/60 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-neutral-400">
        <div>
